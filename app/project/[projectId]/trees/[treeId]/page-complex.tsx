...
export default function ExperimentTreePage() {
  ...
  useEffect(() => {
    // Fetch data immediately without authentication for demo
    fetchTree()
    fetchNodes()
    ...
    getCurrentUser().then((user) => {
      ...
      // User not authenticated, but continue with demo data
    })
      ...
      const mockNodes: TreeNode[] = [
        {
          ...
          description: 'Collect raw RNA-seq data from sequencing facility',
          node_type: 'data',
          position: 1,
          created_at: '2024-01-15T00:00:00Z',
          updated_at: '2024-01-15T00:00:00Z'
        },
        {
          ...
          description: 'Run FastQC to assess raw data quality',
          node_type: 'software_completed',
          position: 2,
          created_at: '2024-01-15T00:00:00Z',
          updated_at: '2024-01-15T00:00:00Z'
        },
        {
          ...
          description: 'Generate comprehensive quality control report',
          node_type: 'results',
          position: 3,
          created_at: '2024-01-15T00:00:00Z',
          updated_at: '2024-01-15T00:00:00Z'
        },
        {
          ...
          tree_id: treeId,
          parent_id: 'node-3',
          name: 'Trimming Protocol',
          description: 'Define trimming parameters and protocol',
          node_type: 'protocols',
          position: 4,
          created_at: '2024-01-15T00:00:00Z',
          updated_at: '2024-01-15T00:00:00Z'
        },
        {
          ...
          tree_id: treeId,
          parent_id: 'node-4',
          name: 'Trimmomatic Processing',
          description: 'Run Trimmomatic to remove adapters and low-quality bases',
          node_type: 'software_completed',
          position: 5,
          created_at: '2024-01-15T00:00:00Z',
          updated_at: '2024-01-15T00:00:00Z'
        },
        {
          ...
          parent_id: 'node-5',
          name: 'Processed Data',
          description: 'Store cleaned and trimmed sequencing data',
          node_type: 'data',
          position: 6,
          created_at: '2024-01-15T00:00:00Z',
          updated_at: '2024-01-15T00:00:00Z'
        },
        {
          ...
          description: 'Validate quality improvements after trimming',
          node_type: 'results',
          position: 7,
          created_at: '2024-01-15T00:00:00Z',
          updated_at: '2024-01-15T00:00:00Z'
        },
        {
          ...
          tree_id: treeId,
          parent_id: 'node-7',
          name: 'Custom QC Script',
          description: 'Develop custom quality control visualization script',
          node_type: 'software_development',
          position: 8,
          created_at: '2024-01-15T00:00:00Z',
          updated_at: '2024-01-15T00:00:00Z'
        }
